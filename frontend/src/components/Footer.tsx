...
const Footer: React.FC = () => {
  return (
    <footer
      className="w-full bg-[#071722] py-8 border-t border-[#1e2a36] flex justify-center"
    >
      <div className="w-full max-w-[1300px] flex flex-col items-center justify-center text-center px-4">
